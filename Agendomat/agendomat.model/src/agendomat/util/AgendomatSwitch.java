 ...
 * @generated
 */
public class AgendomatSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case AgendomatPackage.PROGRAM_ITEM: {
				ProgramItem programItem = (ProgramItem)theEObject;
				T result = caseProgramItem(programItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AgendomatPackage.SESSION: {
				...
				if (result == null) result = caseProgramItem(session);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case AgendomatPackage.BREAK: {
				...
				if (result == null) result = caseProgramItem(break_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Program Item</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Program Item</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProgramItem(ProgramItem object) {
		return null;
	}
